package org.sectorzero.servizio.dropwizard.guice;

import org.sectorzero.servizio.dropwizard.guice.support.GuiceBootstrapModule;
...
public abstract class GuiceApplication<T extends Configuration> extends Application<T> {
    ...
    public abstract void configure(T configuration, org.sectorzero.servizio.dropwizard.guice.support.GuiceSupport.Builder<T> guiceBuilder);
}
